...
impl Attempt {
    ...
    /// from the start. No checkpoints or events exist yet — a first attempt resumes from
    /// no checkpoint, and nothing has been reported.
    #[must_use]
    pub fn scheduled(
        id: AttemptId,
        job: JobId,
...
mod tests {
    ...
    fn scheduled_attempt_carries_committed_placement() {
        ...
        // No checkpoints resumed/produced and nothing reported yet.
